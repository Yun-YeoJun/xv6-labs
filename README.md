...
- Boot xv6 (easy)
    - pass
- sleep (easy)
    - https://github.com/Yun-YeoJun/xv6-labs/blob/util/user/sleep.c
- pingpong (easy)
    - https://github.com/Yun-YeoJun/xv6-labs/blob/util/user/pingpong.c
- primes (moderate)/(hard)
    - https://github.com/Yun-YeoJun/xv6-labs/blob/util/user/primes.c
- find (moderate)
